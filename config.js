module.exports = {
	...
	token: "Nzg0ODg4NDAzNzkwNTI4NTYy.X8v2SQ.KeuDnAln1nfzMhAzBIHNve6wPc0",
	/* For the support server */
	support: {
		id: "XXXXXXXXXXX", // The ID of the support server
		logs: "XXXXXXXXX", // And the ID of the logs channel of your server (new servers for example)
	},
	...
	mongoDB: "mongodb://localhost:27017/", // The URl of the mongodb database
	...
	owner: {
		id: "412738620546613248", // The ID of the bot's owner
		name: "Banana Joe#7042" // And the name of the bot's owner
	},
	...
	status: [
		{
			name: "@Banana help on {serversCount} servers",
			type: "LISTENING"
		},
		{
			name: "my website : PornHub.Com",
			type: "PLAYING"
		}
	],
